...
8. 盾牌可以作为燃料，烧冶1个物品。
9. 兔肉煲的两个配方合二为一。
10. 旗帜图案、石头压力板和磨制黑石压力板、石头按钮和磨制黑石按钮、竹栅栏和木制栅栏、竹栅栏门和木制栅栏门、所有纹饰模板分别被整合进了配方书的同一格。
...
2. 方解石可以由1个滴水石块和1个骨块合成；

	获得滴水石块时解锁配方；

	位于建筑类。

3. 凝灰岩可以由1个岩浆块和1个沙砾合成；

	获得岩浆块时解锁配方；

	位于建筑类。

4. 深板岩可以由1个凝灰岩和1个砂岩或红砂岩合成；

	获得凝灰岩时解锁配方；

	位于建筑类。

5. 镶金黑石可以由1个黑石和4个金粒合成；
...
7. 附魔金苹果可以由1个金苹果和8个金块合成。

	获得附魔金苹果时解锁配方；

	位于杂项类。

8. 铁、金或钻石马铠可以由7个铁锭、金锭或钻石合成。

	获得对应原料时解锁配方；

	位于装备类。

9.  鞘翅可以由1个龙首、1个龙息、1个紫颂花、2个潜影壳和4个幻翼膜合成。

	获得鞘翅时解锁配方；

	位于装备类。

10. 海绵可以由1个热带鱼、4个海晶碎片和4个海晶沙砾合成。

	获得海绵时解锁配方；

	位于装备类。

11. 海洋之心可以由1个干海带块、1个珊瑚块、1个蓝冰、1个岩浆块、1个海晶灯、1个湿海绵、1个三叉戟、1个海龟壳和1个河豚桶合成。

	获得海洋之心时解锁配方；

	位于杂项类。

12. 猪鼻盾徽可以由1个纸和1个猪灵的头合成；
